import { imageLABtoRGBA, imageRGBAtoLAB } from "./colorspaces.js";
...
onmessage = (e) => {
  ...
  const { srcArray, srcWidth, srcHeight } = source;
  const { tgtArray, tgtWidth, tgtHeight } = target;
  ...
  postMessage({
    imgData: tgtArrayColoredRGB,
    imgWidth: tgtWidth,
    imgHeight: tgtHeight,
    arrSamples: srcArraySamples,
  });
};
